...
class FAN(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=False, pretrained=None, out_index=-1, use_checkpoint=False):
        super().__init__()
        img_size = to_2tuple(img_size)
...
class fan_tiny_8_p4_hybrid(FAN):
    def __init__(self, pretrained, **kwargs):
        ...
        super(fan_tiny_8_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=192, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=7, use_checkpoint=True)
...
class fan_small_12_p4_hybrid(FAN):
    def __init__(self, pretrained, **kwargs):
        ...
        super(fan_small_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=384, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=9, use_checkpoint=True)

        
@BACKBONES.register_module()
class fan_base_12_p4_hybrid(FAN):
    def __init__(self, pretrained, **kwargs):
        depth = 16
        model_args = dict(depths=[3, 3], dims=[128, 256, 512, 1024], use_head=False)
        backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
        super(fan_base_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=448, depth=depth, backbone=backbone,
                 num_heads=8, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=15, use_checkpoint=True)
        
@BACKBONES.register_module()
class fan_large_12_p4_hybrid(FAN):
    def __init__(self, pretrained, **kwargs):
        depth = 22
        model_args = dict(depths=[3, 5], dims=[128, 256, 512, 1024], use_head=False)
        backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
        super(fan_large_12_p4_hybrid, self).__init__(
            patch_size=16, in_chans=3, num_classes=80, embed_dim=480, depth=depth, backbone=backbone,
                 num_heads=10, mlp_ratio=4., qkv_bias=True, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.3,
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=True, pretrained=pretrained, out_index=18, use_checkpoint=True)
