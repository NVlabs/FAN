...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=8 --nnodes=$rank_num \
	--node_rank=$rank_index --master_addr="100.127.144.40" --master_port=3349 \
	main.py  ../imagenet_raw/ --model fan_small_12_p16_224_se_attn -b 64 --sched cosine --epochs 300 \
	...
	--smoothing 0.1 \
	--output ../fan_small_12_p16_224_se_attn/ \
	--amp --model-ema \
