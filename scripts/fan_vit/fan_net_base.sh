...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=8 --nnodes=$rank_num \
	--node_rank=$rank_index --master_addr="100.111.244.11" --master_port=3349 \
	main.py  ../imagenet_raw/ --model fan_base_18_p16_224 -b 64 --sched cosine --epochs 300 \
